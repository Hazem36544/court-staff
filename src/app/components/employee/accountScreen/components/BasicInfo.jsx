...
import { Hash, Phone, Mail, User } from 'lucide-react';
...
const BasicInfo = ({ displayName, displayUsername, displayPhone, displayEmail }) => {
    return (
        <div className="lg:col-span-2 bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-6 md:p-8 relative h-full">
            ...
            {/* تم إزالة md:grid-cols-2 ليأخذ كل عنصر السطر بالكامل */}
