...
const ProfileCard = ({ displayName, displayRole, onLogout }) => {
    return (
        <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 flex flex-col items-center text-center relative overflow-hidden h-full">
            ...
            <p className="text-[#1e3a8a] font-bold mb-4 bg-blue-50 px-4 py-1.5 rounded-full text-sm flex items-center gap-1.5">
               <Shield size={16} /> {displayRole}
            </p>

            <div className="mt-auto w-full pt-6 border-t border-gray-100 relative z-10">
                <button 
                    onClick={onLogout}
