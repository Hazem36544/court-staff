...
export const CourtStaffHeader = () => (
  <>
    ...
    <div className="text-center mb-3">
      <h1 className="text-3xl font-black text-[#2c3e50] mb-2 tracking-tight">بوابة موظفي محاكم الأسرة</h1>
      <p className="text-sm font-bold text-[#95a5a6] tracking-wider" style={{ fontFamily: 'Inter, sans-serif' }}>بوابة وصال - لم الشمل</p>
    </div>
  </>
);

export const CourtStaffFooter = () => (
