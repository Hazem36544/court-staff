  ...
  <div className="bg-white rounded-2xl shadow-lg p-8 mb-6 animate-in fade-in duration-500">
    ...
    <div className="space-y-6">
      ...
      <div style={{ position: 'absolute', opacity: 0, zIndex: -1, width: '1px', height: '1px', overflow: 'hidden' }} aria-hidden="true">
        <input type="text" name="chrome_trap_user" autoComplete="username" tabIndex={-1} />
        <input type="password" name="chrome_trap_pass" autoComplete="current-password" tabIndex={-1} />
      </div>
...
export default CourtStaffLoginForm;