    ...
    >
      <div className="w-full max-w-[460px]">
        ...
        <div className="text-center mb-3">
          <h1 className="text-2xl font-bold text-[#2c3e50] mb-2">بوابة موظفي محاكم الأسرة</h1>
        ...
        {step === 'login' && (
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-6 animate-in fade-in duration-500">
            <h2 className="text-xl font-bold mb-8 text-center text-[#2c3e50]">تسجيل دخول الموظف</h2>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="مثال: staff@court.gov.eg"
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-6 animate-in zoom-in-95 duration-300 relative overflow-hidden border-t-4" style={{ borderColor: '#2c5aa0' }}>
            ...
            <div className="space-y-5">
              ...
              <Button
                ...
                className="w-full h-12 text-base font-bold rounded-lg mt-6 flex items-center justify-center gap-2 border-none transition-colors duration-300"
                style={{
